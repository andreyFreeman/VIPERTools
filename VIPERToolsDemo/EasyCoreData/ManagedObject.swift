...
public extension NSManagedObject {
    ...
    class func entityDescription(inContext context: NSManagedObjectContext = NSManagedObjectContext.mainThreadContext) -> NSEntityDescription! {
        switch entityName {
        case .some(let name): return NSEntityDescription.entity(forEntityName: name, in: context)
        default: return nil
        }
    }
}
...
public extension NSManagedObject {
    ...
    class func createEntity(inContext context: NSManagedObjectContext = NSManagedObjectContext.mainThreadContext) -> NSManagedObject! {
        switch entityName {
        case .some(let name): return NSEntityDescription.insertNewObject(forEntityName: name, into: context)
        default: return nil
        }
    }
}
...
public extension NSManagedObject {
     ...
     */
    class func deleteAll(_ predicate: NSPredicate? = nil, inContext context: NSManagedObjectContext = NSManagedObjectContext.mainThreadContext) {
...
public extension NSManagedObject {
     ...
     */
    class func findAll(_ predicate: NSPredicate? = nil, sortDescriptors: [NSSortDescriptor]? = nil, inContext context: NSManagedObjectContext = NSManagedObjectContext.mainThreadContext) -> [NSManagedObject] {
     ...
     */
    class func findFirstOne(_ predicate: NSPredicate? = nil, sortDescriptors: [NSSortDescriptor]? = nil, inContext context: NSManagedObjectContext = NSManagedObjectContext.mainThreadContext) -> NSManagedObject? {
     ...
     */
    class func countOfEntities(_ predicate: NSPredicate? = nil, inContext context: NSManagedObjectContext = NSManagedObjectContext.mainThreadContext) -> Int {
     ...
     */
    class func hasAtLeastOneEntity(_ predicate: NSPredicate? = nil, inContext context: NSManagedObjectContext = NSManagedObjectContext.mainThreadContext) -> Bool {
...
public extension NSManagedObject {
     ...
     */
    class func aggregateOperation(_ function: String, onAttribute attribute: String, predicate: NSPredicate? = nil, context: NSManagedObjectContext = NSManagedObjectContext.mainThreadContext) -> NSNumber? {
        ...
        do {
            let result = try context.fetch(request).first as? [NSObject : AnyObject] ?? [:]
            return result["result" as NSObject] as? NSNumber
        } catch {
            return nil
        }
    }
